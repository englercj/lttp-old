define([
    ...
    var Renderer = function (gl, canvas) {
        ...
        this.tileMap.setSpriteSheet('assets/maps/overworld/lttp-tiles.png');
        this.tileMap.setTileLayer('assets/maps/overworld/lttp-all.png', 0);
    ...
    Renderer.prototype.pan = function (x, y) {
        //Controls.update() calls this function, but it does so
        //faster than textureSize is set, so we need to ignore
        //the case where these are 0
        if(!this.tileMap.layers[0].textureSize[0] || !this.tileMap.layers[0].textureSize[1])
            return;
