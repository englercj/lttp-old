...
define(
  'camera/Camera',['require','exports','module','../display/Container','../display/Sprite','../geom/Rectangle','../math/Vector','../utils/ObjectPool','../utils/ObjectFactory','../utils/inherit','../math/math','../constants'],function (require, exports, module) {
  
// uRequire v0.6.2-01: START body of original nodejs module
  var Container = require("../display/Container"), Sprite = require("../display/Sprite"), Rectangle = require("../geom/Rectangle"), Vector = require("../math/Vector"), ObjectPool = require("../utils/ObjectPool"), ObjectFactory = require("../utils/ObjectFactory"), inherit = require("../utils/inherit"), math = require("../math/math"), C = require("../constants");
